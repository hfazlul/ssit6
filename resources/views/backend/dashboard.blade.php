        ...
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tr>
                    <td>
                        <div class="product-img bg-transparent border">
                            <img src="{{asset('/')}}assets/images/icons/smartphone.png" width="35" alt="">
                        </div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="product-img bg-transparent border">
                            <img src="{{asset('/')}}assets/images/icons/watch.png" width="35" alt="">
                        </div>
                    </td>
                    <td>Hand Watch</td>
                    <td>Milona Burke</td>
                ...
                <tr>
                    <td>
                        <div class="product-img bg-transparent border">
                            <img src="{{asset('/')}}assets/images/icons/laptop.png" width="35" alt="">
                        </div>
                    </td>
                    <td>Mini Laptop</td>
                    <td>Craig Clayton</td>
                ...
                <tr>
                    <td>
                        <div class="product-img bg-transparent border">
                            <img src="{{asset('/')}}assets/images/icons/shirt.png" width="35" alt="">
                        </div>
                    </td>
                    <td>Slim-T-Shirt</td>
                    <td>Clark Andola</td>
