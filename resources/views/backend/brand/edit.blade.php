...
<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
    <div class="breadcrumb-title pr-3">Brands</div>
    <div class="pl-3">
                ...
                <form action="{{ route('staff.brand.update', $brand->id) }}" method="post">
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="name" name="name" value="{{ $brand->name }}" class="form-control" placeholder="Enter brand name">
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 text-center">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="active" name="status" value="active" {{ $brand->status === 'Active' ? 'checked' : '' }} class="custom-control-input">
                                        <label class="custom-control-label" for="active">Active</label>
                                     </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="inactive" name="status" value="inactive" {{ $brand->status === 'Inactive' ? 'checked' : '' }} class="custom-control-input">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-10 text-right" >
                                <button type="submit" class="btn btn-primary px-4">Update Brands</button>
                            </div>
                        </div>
